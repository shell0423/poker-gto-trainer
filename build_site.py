...
<div id="howto">
  ...
  <ul>
    ...
    <li><b>SRP戦略</b>＝BTN vs BBのフロップで、自分のハンドの<b>GTOアクション</b>を当てる練習。BTNのc-betは<b>全1755フロップ（戦略的に異なる全盤面を網羅）</b>の実戦的2ストリート解、BBの守備（フォールド/コール/チェックレイズ）は38盤から出題。混合戦略なので、<b>GTOが使う行動ならどれも正解</b>として頻度を表示します。</li>
  </ul>
