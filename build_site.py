...
function setQMode(m){
  ...
  if(m==='strat'){pickQuiz();updScore();}else{pickTermQuiz();updTScore();}
}
...
document.addEventListener('keydown',e=>{if(e.key==='Enter'&&document.getElementById('quiz').classList.contains('on')){qmode==='strat'?pickQuiz():pickTermQuiz();}});
